...
import 'package:userapp/model/city_model.dart';
...
class _DoctorsListPageState extends State<DoctorsListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: IAppBar.commonAppBar(title: "Bác sĩ"),
  ...
  _buildBody() {
    ...
    ISearchBox.buildSearchBox(
      ...
      labelText: "Tìm kiếm bác sĩ, phòng khám, chuyên khoa, khoa",
          onChanged: (){
         ...
         title:   Padding(
             ...
             child: Row(
                 ...
                 children:[
                   ...
                   dataList.length<4?Container(): const Text('Vuốt để xem thêm >>',
                     style: TextStyle(
                         color: Colors.grey,
                         fontWeight: FontWeight.w600,
                         fontSize: 14
