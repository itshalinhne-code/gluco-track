...
import 'package:userapp/model/testimonial_model.dart';
import 'package:userapp/services/clinic_service.dart';
import 'package:userapp/services/doctor_service.dart';
import 'package:userapp/services/testimonial_service.dart';
...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: IAppBar.commonAppBar(title: clinicModel?.title?? "Phòng khám"),
      ...
      child: ListTile(
        subtitle: Padding(
          ...
          child: Row(
            ...
            children: [
              clinicModel?.phone==null|| clinicModel?.phone==""?Container(): _buildTapBox(ImageConstants.telephoneImageBox, "Call",()async{
                if( clinicModel?.phone!=null&& clinicModel?.phone!=""){
                  await launchUrl(Uri.parse("Gọi :${ clinicModel?.phone}"));
                }
              }),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children:[
                                            ...
                                            Text("${doctorsModel.averageRating} (${doctorsModel.numberOfReview} đánh giá)",
                                              style: const TextStyle(
                                                  color: ColorResources.secondaryFontColor,
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 12
                                        ...
                                        Row(
                                          children:[
                                            ...
                                            Text("Kinh nghiệm ${doctorsModel.exYear??"--"} năm",
                                              style:const TextStyle(
                                                  color: ColorResources.secondaryFontColor,
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 12
                                        ...
                                        doctorsModel.stopBooking==1?  const Padding(
                                          ...
                                          child: Row(
                                            children:[
                                              ...
                                              SizedBox(width: 5),
                                              Text("Hiện tại không nhận lịch hẹn",
                                                style:TextStyle(
                              ...
                              children: [
                                Row(
                                  children:[
                                    ...
                                    const SizedBox(width: 5),
                                    Text("${doctorsModel.totalAppointmentDone} Lịch hẹn đã đặt",
                                      style:const TextStyle(
                                          color: ColorResources.secondaryFontColor,
                                          fontWeight: FontWeight.w500,
                                          fontSize: 12
