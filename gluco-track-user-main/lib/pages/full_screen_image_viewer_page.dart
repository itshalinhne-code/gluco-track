...
class _FullScreenImageViewerPageState extends State<FullScreenImageViewerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:IAppBar.commonAppBar(title: widget.clinicName??""), // Tiêu đề là tên phòng khám (nếu có)
      body: PhotoViewGallery.builder(
        ...
        scrollPhysics: BouncingScrollPhysics(), // Hiệu ứng cuộn nảy
        backgroundDecoration: BoxDecoration(color: Colors.black), // Nền màu đen
      ),
    );
  }
}