...
class _PatientFilePageState extends State<PatientFilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: IAppBar.commonAppBar(title: "Tệp"),
      body:  ListView(
        padding: const EdgeInsets.all(8),
        controller: scrollController,
        children: [
          const SizedBox(height: 10),
          ISearchBox.buildSearchBox(textEditingController: _searchTextController,labelText: "Tìm kiếm báo cáo",onFieldSubmitted:(){
