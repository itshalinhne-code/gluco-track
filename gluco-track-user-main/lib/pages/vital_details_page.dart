...
class _VitalsDetailsPageState extends State<VitalsDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: IBottomNavBarWidget(title: "Gia đình",
          onPressed: () {
            _openBottomSheetFamilyMember();
          },
        ),
        appBar: IAppBar.commonAppBar(
            title: "$selectedVital ${getParameter(selectedVital)}"),
        ...
        ListView(
          ...
          children: [
            selectedFamilyMemberModel == null ? Container() : Padding(
              ...
              child: Card(
                  ...
                  child: ListTile(
                      ...
                      title: Text(
                    "Tên - ${selectedFamilyMemberModel?.fName ??
            ...
            InputDecorator(
              decoration: ThemeHelper().textInputDecoration('Chọn chỉ số sức khỏe*'),
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  padding: EdgeInsets.zero,
                  value: selectedVital,
                  hint: const Text('Chọn chỉ số sức khỏe',
                      style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey,
                          fontWeight: FontWeight.w500
            ...
            Obx(() {
              ...
              Column(
                children: [
                  ...
                  const Divider(),
                  const Text("Huyết áp tâm trương",
                    style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w500
                    ),
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Text("Đăng ký thành viên gia đình mới",
                            style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 15
                            ),),
  ...
  _buildTitleBP(VitalModel vitalModel) {
    return Column(
      ...
      children: [
        Text("Huyết áp tâm thu - ${vitalModel.bpSystolic.toString()} mmHg",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
        const SizedBox(height: 5),
        Text("Huyết áp tâm trương - ${vitalModel.bpDiastolic.toString()} mmHg",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
    ...
    return Column(
      ...
      children: [
        vitalModel.sugarRandom == null ? Container() : Text(
          "Đường huyết - ${vitalModel.sugarRandom.toString()} Mg/dl",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
        ...
        vitalModel.sugarFasting == null ? Container() : Text(
          "Đường huyết - ${vitalModel.sugarFasting.toString()} Mg/dl",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
  ...
  _buildTitleWeight(VitalModel vitalModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Cân nặng - ${vitalModel.weight.toString()} KG",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
  ...
  _buildTitleTemp(VitalModel vitalModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Nhiệt độ - ${vitalModel.temperature.toString()} F",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
  ...
  _buildTitleSpo2(VitalModel vitalModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("SpO2 - ${vitalModel.spo2.toString()} %",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InputLabel.buildLabelBox("Ngày"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Thời gian"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Huyết áp tâm thu (mmHg)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: Platform.isIOS ? const TextInputType
                                  ...
                                  : TextInputType.number,
                              validator: (item) {
                                return item!.isNotEmpty ? null : "Nhập giá trị";
                              },
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Huyết áp tâm trương (mmHg)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Cân nặng (KG)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Nhiệt độ (F)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("SpO2 (%)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Đường huyết ngẫu nhiên (Mg/dl)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Đường huyết đầy đủ (Mg/dl)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                          ...
                          SmallButtonsWidget(title: "Lưu", onPressed: () {
                            if (_sugarFastingController.text.isEmpty &&
                              ...
                              IToastMsg.showMessage("Vui lòng điền ít nhất một trường");
                            } else {
                              Get.back();
                              if (vitalModel == null) {
                                handleAddVital();
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text("Bạn có chắc chắn muốn xóa bản ghi này?",
                  textAlign: TextAlign.center,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SmallButtonsWidget(
                                title: "Xác nhận", onPressed: () {
                              if (argsDate == null) {
                                IToastMsg.showMessage("Chọn ngày");
