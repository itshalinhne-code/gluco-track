...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      child: Scaffold(
          appBar: IAppBar.commonAppBar(title: "Thông báo"),
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(
                "${notificationModel.id}${notificationModel.title}",
  ...
  void getAndOpenPre(String? pId) async {
    ...
    final prescription =
        await PrescriptionService.getDataByPrescriptionId(prescriptionId: pId ?? "");
