import 'package:doctorapp/pages/patient_file_page.dart';
...
class RouteHelper {
  ...
  static String getPatientFilePagePageRoute({required String patientId}) =>
      "$patientFilePage?patientId=$patientId";
  static String getAppointmentPageRoute() => appointmentPagePage;
  static String getPrescriptionPageRoute() => prescriptionPage;
  static String getAddPrescriptionPageRoute(
          {required String appId, required String prescriptionId}) =>
      "$addPrescriptionPage?appId=$appId&prescriptionId=$prescriptionId";
