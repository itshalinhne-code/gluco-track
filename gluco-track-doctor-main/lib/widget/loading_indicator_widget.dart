...
class _IVerticalListLongLoadingWidgetState extends State<IVerticalListLongLoadingWidget>
  ...
  void initState() {
    ...
    _animationOne = ColorTween(begin: Colors.grey, end: Colors.white).animate(_controller!);
    _animationTwo = ColorTween(begin: Colors.white, end: Colors.grey).animate(_controller!);
    _controller!.forward();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ShaderMask(
        shaderCallback: (rect) {
          return LinearGradient(colors: [_animationOne!.value!, _animationTwo!.value!])
              .createShader(rect);
        },
