...
class AppointmentCancellationService {
  ...
  static List<AppointmentCancellationRedModel> dataFromJson(jsonDecodedData) {
    return List<AppointmentCancellationRedModel>.from(
        jsonDecodedData.map((item) => AppointmentCancellationRedModel.fromJson(item)));
  }

  static Future<List<AppointmentCancellationRedModel>?> getData(
