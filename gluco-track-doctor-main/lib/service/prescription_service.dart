...
class PrescriptionService {
  ...
  static Future deleteData({required String id}) async {
  ...
  static List<PrescriptionModel> dataFromJson(jsonDecodedData) {
    return List<PrescriptionModel>.from(
        jsonDecodedData.map((item) => PrescriptionModel.fromJson(item)));
  }

  static Future<List<PrescriptionModel>?> getData({required String appointmentId}) async {
    final body = {"appointment_id": appointmentId};
  ...
  static Future<PrescriptionModel?> getDataByPrescriptionId(
